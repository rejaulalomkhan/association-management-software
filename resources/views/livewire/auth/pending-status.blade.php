    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-indigo-600 to-purple-600 p-8 text-white">
            <div class="flex items-center justify-center mb-4">
                ...
                @endphp
                @if($orgLogo)
                    <img src="{{ asset('storage/' . $orgLogo) }}" alt="{{ $orgName }}" class="h-20 w-auto">
                @endif
            </div>
            <h1 class="text-3xl font-bold text-center mb-2">{{ $orgName }}</h1>
            @if($orgAddress)
                <p class="text-center text-indigo-100 mb-1">{{ $orgAddress }}</p>
            @endif
            @if($orgPhone)
                <p class="text-center text-indigo-100">ফোন: {{ $orgPhone }}</p>
            @endif
        </div>
        ...
        <div class="p-8">
            ...
            <div class="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="flex border-b border-gray-200 dark:border-gray-700 pb-3">
                        ...
                        <span class="text-gray-900 dark:text-gray-100">{{ $user->father_name }}</span>
                    </div>
                    <div class="flex border-b border-gray-200 dark:border-gray-700 pb-3">
                        <span class="font-semibold text-gray-700 dark:text-gray-300 w-40">জন্ম তারিখ:</span>
                        <span class="text-gray-900 dark:text-gray-100">{{ \Carbon\Carbon::parse($user->dob)->format('d/m/Y') }}</span>
                    </div>
                    <div class="flex border-b border-gray-200 dark:border-gray-700 pb-3">
                    ...
                    <div class="flex border-b border-gray-200 dark:border-gray-700 pb-3">
                        ...
                        <span class="text-gray-900 dark:text-gray-100">{{ $user->blood_group }}</span>
                    </div>
                    <div class="flex border-b border-gray-200 dark:border-gray-700 pb-3">
                        <span class="font-semibold text-gray-700 dark:text-gray-300 w-40">পেশা:</span>
                        <span class="text-gray-900 dark:text-gray-100">{{ $user->profession }}</span>
                    </div>
                    <div class="flex border-b border-gray-200 dark:border-gray-700 pb-3">
                        <span class="font-semibold text-gray-700 dark:text-gray-300 w-40">ধর্ম:</span>
                        <span class="text-gray-900 dark:text-gray-100">{{ $user->religion }}</span>
                    </div>
                    <div class="flex border-b border-gray-200 dark:border-gray-700 pb-3">
                        <span class="font-semibold text-gray-700 dark:text-gray-300 w-40">জাতীয়তা:</span>
                        <span class="text-gray-900 dark:text-gray-100">{{ $user->nationality }}</span>
                    </div>
                    <div class="flex border-b border-gray-200 dark:border-gray-700 pb-3 md:col-span-2">
                        ...
                        <span class="text-gray-900 dark:text-gray-100">{{ $user->present_address }}</span>
                    </div>
                    <div class="flex border-b border-gray-200 dark:border-gray-700 pb-3 md:col-span-2">
                        <span class="font-semibold text-gray-700 dark:text-gray-300 w-40">স্থায়ী ঠিকানা:</span>
                        <span class="text-gray-900 dark:text-gray-100">{{ $user->permanent_address }}</span>
                    </div>
                    @if($user->position)
                    <div class="flex border-b border-gray-200 dark:border-gray-700 pb-3 md:col-span-2">
                        <span class="font-semibold text-gray-700 dark:text-gray-300 w-40">পদবী:</span>
                        <span class="text-gray-900 dark:text-gray-100">{{ $user->position }}</span>
                    </div>
                    @endif
                </div>
            </div>
            ...
            <div class="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-500 p-6 rounded-r-lg">
                <div class="flex items-start">
                    ...
                    <div>
                        <h4 class="text-lg font-semibold text-blue-900 dark:text-blue-200 mb-2">গুরুত্বপূর্ণ বিজ্ঞপ্তি</h4>
