    ...
    @if($showTerms)
        ...
        <div class="max-w-3xl mx-auto">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
                ...
                <!-- Terms Content (managed from /admin/settings → শর্তাবলী tab) -->
                @php
                    $settingsService = app(\App\Services\SettingsService::class);
                    $termsHtml = $settingsService->get('registration_terms', '');
                    $termsHtml = str_replace('{org_name}', e(org_name()), $termsHtml);
                    $acceptanceLabel = $settingsService->get(
