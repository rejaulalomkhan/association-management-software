            ...
            <div class="p-2 sm:p-6 w-full">
                ...
                <div class="flex gap-3 items-start w-full sm:hidden relative overflow-hidden">
                    ...
                    <div class="flex-shrink-0 relative z-10">
                        @if(->profile_pic)
                            <img src="{{ asset('storage/' . ->profile_pic) }}" alt="{{ ->name }}" class="object-cover w-20 h-20 border-2 border-gray-300 rounded-full">
                        @else
                        ...
                        <div class="flex justify-center gap-2 mt-2">
                            @php
                                ...
                                $message = urlencode("হেলো " . ->name . ",\n" . $orgName . " থেকে যোগাযোগ করছি।");
                            @endphp
                            <a href="https://wa.me/88{{ preg_replace('/[^0-9]/', '', ->phone) }}?text={{ $message }}" target="_blank" class="flex items-center justify-center w-7 h-7 text-white transition-colors bg-green-500 rounded-full hover:bg-green-600" title="WhatsApp">
                            ...
                            <a href="tel:{{ ->phone }}" class="flex items-center justify-center w-7 h-7 text-white transition-colors bg-blue-500 rounded-full hover:bg-blue-600" title="কল করুন">
                    ...
                    <div class="flex-1 min-w-0 relative z-10">
                        <div class="flex items-center gap-2 mb-1">
                            <h2 class="text-base font-bold text-gray-900 dark:text-gray-100 truncate">{{ ->name }}</h2>
                            @if(->blood_group)
                        ...
                        <div class="space-y-0.5 text-xs text-gray-700 dark:text-gray-300">
                            ...
                            <p class="flex items-center">
                                ...
                                <span class="truncate">
                                    ...
                                    @if(->position && ->profession) • @endif
                                    @if(->profession){{ ->profession }}@endif
                                </span>
                            </p>
                            @endif
                            @if(->phone)
                            <p class="flex items-center">
                                ...
                                <a href="tel:{{ ->phone }}" class="text-blue-600 hover:underline dark:text-blue-400 truncate">{{ ->phone }}</a>
                            </p>
                            @endif
                            @if(->email)
                            <p class="flex items-center">
                                ...
                                <a href="mailto:{{ ->email }}" class="text-purple-600 hover:underline dark:text-purple-400 truncate">{{ ->email }}</a>
                            </p>
                            @endif
                            ...
                            <p class="flex items-start">
                                ...
                                <span class="flex-1">{{ ->permanent_address }}</span>
                            </p>
                            @endif
                        </div>
                    </div>
                ...
                <div class="hidden sm:flex flex-col gap-3 items-center text-center w-full sm:flex-row sm:text-left sm:items-start sm:gap-6">
                    ...
                    <div class="flex-shrink-0 w-full sm:w-auto flex flex-col items-center">
                        @if(->profile_pic)
                            <img src="{{ asset('storage/' . ->profile_pic) }}" alt="{{ ->name }}" class="object-cover w-20 h-20 border-4 border-gray-300 rounded-full sm:w-24 sm:h-24">
                        @else
                        ...
                        <div class="flex justify-center gap-2 mt-2">
                            @php
                                ...
                                $message = urlencode("হেলো " . ->name . ",\n" . $orgName . " থেকে যোগাযোগ করছি।");
                            @endphp
                            <a href="https://wa.me/88{{ preg_replace('/[^0-9]/', '', ->phone) }}?text={{ $message }}" target="_blank" class="flex items-center justify-center w-8 h-8 text-white transition-colors bg-green-500 rounded-full hover:bg-green-600" title="WhatsApp">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413Z"/>
                                </svg>
                            </a>
                            <a href="tel:{{ ->phone }}" class="flex items-center justify-center w-8 h-8 text-white transition-colors bg-blue-500 rounded-full hover:bg-blue-600" title="কল করুন">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
                                </svg>
                            </a>
                    ...
                    <div class="flex-1 w-full">
                        <div class="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                            <div class="flex-1">
                                <div class="flex flex-wrap items-center justify-center gap-1 sm:justify-start">
                                    <h2 class="text-lg sm:text-2xl font-bold text-gray-900 dark:text-gray-100">{{ ->name }}</h2>
                                    @if(->blood_group)
                                ...
                                @if(->membership_id)
                                <p class="mt-1 text-xs sm:text-sm text-center text-gray-600 sm:text-left dark:text-gray-400">সদস্য আইডি: <span class="font-mono font-semibold">{{ ->membership_id }}</span></p>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="mt-2 space-y-1 text-xs sm:text-sm text-gray-700 dark:text-gray-300">
                            ...
                            <p class="flex items-center justify-center text-center sm:justify-start sm:text-left">
                                ...
                                <a href="tel:{{ ->phone }}" class="ml-1 text-blue-600 hover:text-blue-800 hover:underline dark:text-blue-400 dark:hover:text-blue-300">{{ ->phone }}</a>
                            </p>
                            @endif
                            @if(->email)
                            <p class="flex items-center justify-center text-center sm:justify-start sm:text-left">
                                ...
                                <a href="mailto:{{ ->email }}" class="ml-1 text-purple-600 break-all hover:text-purple-800 hover:underline dark:text-purple-400 dark:hover:text-purple-300">{{ ->email }}</a>
                            </p>
                            @endif
                            @if(->permanent_address)
                            <p class="flex items-start justify-center text-center sm:justify-start sm:text-left">
                                ...
                                <span class="font-medium">স্থায়ী ঠিকানা:</span> <span class="ml-1">{{ ->permanent_address }}</span>
                            </p>
                            @endif
                            @if(->present_address && ->present_address !== ->permanent_address)
                            <p class="flex items-start justify-center text-center sm:justify-start sm:text-left">
                                <svg class="w-4 h-4 mr-2 mt-0.5 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
                                </svg>
                                <span class="font-medium">বর্তমান ঠিকানা:</span> <span class="ml-1">{{ ->present_address }}</span>
                            </p>
                            @endif
                        </div>
                    </div>
                        ...
                        <form wire:submit.prevent="updateBasicInfo" class="mt-6 space-y-6">
                            ...
                            <div class="flex flex-col items-center space-y-4" x-data="{ photoPreview: null }">
                                <div class="relative">
                                    ...
                                    <template x-if="!photoPreview">
                                        @if(->photo)
                                            <img src="{{ asset('storage/' . ->photo) }}" alt="{{ ->name }}" class="object-cover w-32 h-32 border-4 border-gray-300 rounded-full">
                                        @else
