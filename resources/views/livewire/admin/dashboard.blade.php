                        ...
                        <tr class="transition-colors hover:bg-gray-50 dark:hover:bg-gray-700/50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center gap-2">
                                    {{-- Pay button --}}
                                    <a href="{{ route('member.payment') }}?user_id={{ $member->id }}" wire:navigate
                                       class="inline-flex items-center justify-center px-3 py-1.5 text-xs font-semibold text-white transition-all transform bg-blue-600 rounded-lg hover:bg-blue-700 hover:scale-105 shadow-md hover:shadow-lg"
                                       title="পেমেন্ট সাবমিট করুন">
