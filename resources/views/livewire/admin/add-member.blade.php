<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">নতুন সদস্য যুক্ত করুন</h1>
            <p class="text-sm text-gray-600 mt-1">সরাসরি নতুন সদস্য যুক্ত করুন</p>
        </div>
    ...
    <form wire:submit.prevent="addMember" class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-6">
                <div>
                    @if ($profile_pic)
                        <img src="{{ $profile_pic->temporaryUrl() }}" alt="Preview"
                ...
                <div class="flex-1">
                    <label class="block text-sm font-medium text-gray-700 mb-2">ছবি আপলোড করুন</label>
                    <input type="file" wire:model="profile_pic" accept="image/*"
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" wire:model="phone" placeholder="01XXXXXXXXX"
                ...
                <div>
                    ...
                    <input type="password" wire:model="password" placeholder="সর্বনিম্ন ৮ অক্ষর"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="flex items-center space-x-3">
                <input type="checkbox" wire:model="auto_approve" id="auto_approve"
                    class="w-5 h-5 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
                <label for="auto_approve" class="text-sm font-medium text-gray-700">
                    সরাসরি অনুমোদন করুন এবং সদস্য নম্বর তৈরি করুন
                </label>
            </div>
            <p class="text-xs text-gray-500 mt-2 ml-8">
                চেক না করলে সদস্য "অপেক্ষমাণ" অবস্থায় থাকবে এবং পরে অনুমোদন করতে হবে
            </p>
        </div>
