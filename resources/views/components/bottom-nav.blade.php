<div class="grid grid-cols-4 h-16">
    ...
    <a href="{{ route('admin.pending-registrations') }}" wire:navigate class="flex flex-col items-center justify-center text-gray-500 hover:text-indigo-600 {{ request()->routeIs('admin.pending-registrations') ? 'text-indigo-600' : '' }}">
    ...
    <a href="{{ route('member.profile.edit') }}" wire:navigate class="flex flex-col items-center justify-center text-gray-500 hover:text-indigo-600 {{ request()->routeIs('member.profile.edit') ? 'text-indigo-600' : '' }}">
