...
return [
    ...
    */
    'pages' => [
        ...
        'forgot_password' => [
            'title' => env('TYRO_LOGIN_FORGOT_PASSWORD_TITLE', 'পাসওয়ার্ড ভুলে গেছেন?'),
            'subtitle' => env('TYRO_LOGIN_FORGOT_PASSWORD_SUBTITLE', 'আপনার ইমেল লিখুন এবং আমরা আপনাকে একটি রিসেট লিঙ্ক পাঠাব।'),
            'background_title' => env('TYRO_LOGIN_FORGOT_PASSWORD_BG_TITLE', 'আপনার পাসওয়ার্ড ভুলে গেছেন?'),
            'background_description' => env('TYRO_LOGIN_FORGOT_PASSWORD_BG_DESCRIPTION', 'চিন্তা নেই! আপনার ইমেল লিখুন এবং আমরা আপনাকে আপনার পাসওয়ার্ড রিসেট করার জন্য একটি লিঙ্ক পাঠাব।'),
        ],
        'reset_password' => [
            'title' => env('TYRO_LOGIN_RESET_PASSWORD_TITLE', 'পাসওয়ার্ড রিসেট'),
            'subtitle' => env('TYRO_LOGIN_RESET_PASSWORD_SUBTITLE', 'আপনার নতুন পাসওয়ার্ড লিখুন।'),
            'background_title' => env('TYRO_LOGIN_RESET_PASSWORD_BG_TITLE', 'পাসওয়ার্ড রিসেট'),
            'background_description' => env('TYRO_LOGIN_RESET_PASSWORD_BG_DESCRIPTION', 'আপনার নতুন পাসওয়ার্ড লিখুন।'),
        ],
    ],
